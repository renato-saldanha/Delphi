...
uses
  ...
  Controller.Interfaces, Model.Connections.DBExpress, Controller, Model.Connections.FireDac;
...
begin
  FController.Connections.DBExpress
    .DBGrid(DBgDBExpress)
...
begin
  FController.Connections.FireDac
    .DBGrid(DBgFireDac)
    .DBNavigator(DBNavigator)
    .Open('SELECT * FROM usuarios');
end;
